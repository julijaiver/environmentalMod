/* 
* SHA-256 implementation by Programming Algorithms
* https://www.programmingalgorithms.com/algorithm/sha256/c/
* Modifications: removed uint and uchar defines,
* typecasted malloc to (char*)
* typecasted data to (unsigned char*) for using in SHA256Update function
*/
