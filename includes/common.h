...
#define BOOT_WAIT()   { k_event_wait(&envisens_events, BOOT_CONTINUE_EVENT, true, K_FOREVER); }
#define CLOCK_WAIT()   { k_event_wait(&envisens_events, CLOCK_SET_EVENT, true, K_FOREVER); }
